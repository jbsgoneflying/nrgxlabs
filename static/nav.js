...
(function () {
  ...
  var NAV_ITEMS = [
    ...
    { href: "/ic-scenario",     label: "Engine 14",       desc: "IC scenario simulator — path-dependent outcome replay" },
    { href: "/earnings-ic",     label: "Engine 15",       desc: "Earnings IC scenario — single-name planned-exit replay" },
  ];
